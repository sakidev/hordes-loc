export default {
  ...
  description: {
    ...
    es: 'Los Guerreros están hechos para tanquear muchos más monstruos que cualquier otra clase teniendo mucho poder defensivo gracias a su equipo (Escudos) y otras fuertes ventajas pasivas.',
