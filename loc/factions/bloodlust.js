export default {
  ...
  description: {
    ...
    ru: 'Орда Bloodlust ценит свободу и лояльность, предлагая место для индивидуализма или даже хаоса. Их оборона находится в пустынном мире, названном Headless Landing.',
    es: 'A la horda Bloodlust le importan la libertad y lealtad, invita al individualismo o incluso al caos. Su hogar reside en un reino desértico llamado Headless Landing.',
    ...
    da: 'Blodlust horde værdsætter frihed og loyalitet, giver plads til individualisme eller endda kaos. Deres forsvar er placeret i et ørkenområde kaldet Headless Landing.'
  }
}
